...
var UserModel = /** @class */ (function () {
    ...
    UserModel.prototype.generateToken = function (username) {
        return jsonwebtoken_1.default.sign({ username: username }, process.env.JWT_PASS);
    };
    // get all users
    ...
    UserModel.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, res, pepper, salt, hash, conn_1, sql_1, result, username, token, err_3, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [user.username])];
                    case 2:
                        res = _a.sent();
                        if (res.rows.length) {
                            return [2 /*return*/, null];
                    ...
                    case 4:
                        conn_1 = _a.sent();
                        sql_1 = 'INSERT INTO users (username,firstName,lastName,password) VALUES ($1, $2, $3, $4) RETURNING *';
                        return [4 /*yield*/, conn_1.query(sql_1, [
                                user.username,
                                user.firstname,
                                user.lastname,
                                hash,
    ...
    //delete user
    UserModel.prototype.delete = function (username) {
        return __awaiter(this, void 0, void 0, function () {
